        ...
        <div className="md:flex items-center justify-between">
          <div className="md:w-2/3 md:pr-12 mb-8 md:mb-0">
            <h2 className="text-3xl font-heading font-bold text-white sm:text-4xl animate-fade-up">
              Need Neurological Consultation?
            </h2>
            <p className="mt-4 text-xl text-blue-100 animate-fade-up" style={{animationDelay: "100ms"}}>
              We're here to help with all your neurological concerns. Book an appointment or call for consultation.
            </p>
          </div>
